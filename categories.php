...
?>
                            <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
                                ...
                                <div class="relative flex items-end overflow-hidden rounded-xl">
                                    <img src="assets/image_category/<?php echo $cate->getImg(); ?>" alt="Hotel Photo" />
                                    </div>
                                    
                                    <div class="mt-1 p-2">
                                    <h2 class="text-slate-700"><?php echo $cate->getName() ; ?></h2>
                                    <p class="mt-1 text-sm text-slate-400"> <?php echo $cate->getDescription() ; ?></p>
                                    
                                    <div class="mt-3 flex items-end justify-between"> 
                                    <div class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                                    
                                    
                                    <a href="action_cat.php?delete=<?php echo $cate->getId(); ?>"><button class="text-sm">Supprimer</button></a>

                                    </div>
                                    <div class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                                    
 
                                    <a href="edit_cat.php?edit=<?php echo $cate->getId() ; ?>"><button class="text-sm">Modifier</button></a>
                                    </div>
                                    </div>
                                </div>
                                </a>
