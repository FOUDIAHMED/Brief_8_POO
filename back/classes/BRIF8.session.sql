...
CREATE TABLE commande(
    ...
    constraint fk_cl FOREIGN KEY (idc) REFERENCES client(idclient)
);
--@block
...
begin
insert into commande (idc,datecommande,datelivraison,dateenvoi,montant,statutcommande) values(client,datec,dateliv,dateenv,montant,statut);
