      ...
      <article class="rounded-xl mt-10  bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
        <form action="action_cat.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="mt-10 p-2">
            ...
            <input class="text-slate-700" id="catName" name="catName" placeholder="name de category" value="<?php echo $c->getName(); ?>"></input>

            <input class="text-slate-700" name="catDescription" placeholder="description here" value="<?php echo $c->getDescription(); ?>"></input>
            ...
            <div class="mt-3 flex items-end justify-between">
              ...
              <div class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
                ...
                <a class="text-sm"><button name="update" value="<?php echo $c->getId(); ?>">submit</button></a>
                </button>
              </div>
            </div>
          </div>
